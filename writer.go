...
type fieldNeedsQuotesCallback func(int, string) bool
...
type Writer struct {
	...
	w           *bufio.Writer
	NeedsQuotes fieldNeedsQuotesCallback
}
...
func (w *Writer) Write(record []string) error {
	for n, field := range record {
		...
		fq := w.fieldNeedsQuotes(field) || (w.NeedsQuotes != nil && w.NeedsQuotes(n, field))
